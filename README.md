# Collect Old Tweets Programatically
A project written in Python to get old tweets, it bypass some limitations of Twitter Official API.

## Details
Twitter Official API has the bother limitation of time constraints, you can't get older tweets than a week. Jefferson-Henrique found a solution for it where which I credit his work here: https://github.com/Jefferson-Henrique/GetOldTweets-python
